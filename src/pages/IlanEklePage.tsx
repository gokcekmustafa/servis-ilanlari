...
export default function IlanEklePage({ onGoBack, onSuccess, userId }: IlanEklePageProps) {
  ...
  // YENİ: Aracimi Satiyorum state
  const [aracimiSatiyorum, setAracimiSatiyorum] = useState({
    marka: '', model: '', yil: '', plaka: '', koltuk_sayisi: '',
    arac_tipi: '', km: '', ucret: '', hasar_kaydi: 'yok',
    noter_satisi: false, aracla_birlikte_plaka: false,
  });
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-3">
                          ...
                          <div>
                            ...
                            <select className={ic} value={yeniAracForm.arac_tipi}
                              ...
                              <option value="">Secin</option>
                              {['Minibus 16+1', 'Midibus 27+1', 'Otobus 45+1', 'Sedan', 'Van'].map((t) => (
                  ...
                  <div className="border border-slate-200 rounded-xl p-4 md:p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                      <div>
                        ...
                        <select value={soforAriyorum.odeme_sekli}
                ...
                {selectedKategori === 'aracimi_satiyorum' && (
                  <div className="border border-slate-200 rounded-xl p-4 md:p-5">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                      <div>
                        <label className={lb}>Marka</label>
                        <select value={aracimiSatiyorum.marka}
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, marka: e.target.value })} className={ic}>
                          <option value="">Secin</option>
                          {['Mercedes', 'Ford', 'Volkswagen', 'Renault', 'Peugeot', 'Citroen', 'Iveco', 'Temsa', 'Isuzu'].map((m) => (
                            <option key={m} value={m}>{m}</option>
                          ))}
                      ...
                      <div>
                        <label className={lb}>Model</label>
                        <input value={aracimiSatiyorum.model} placeholder="Sprinter, Transit..."
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, model: e.target.value })} className={ic} />
                      </div>
                      <div>
                        <label className={lb}>Yil</label>
                        <select value={aracimiSatiyorum.yil}
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, yil: e.target.value })} className={ic}>
                          <option value="">Secin</option>
                      ...
                      <div>
                        <label className={lb}>Koltuk Sayisi</label>
                        <select value={aracimiSatiyorum.koltuk_sayisi}
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, koltuk_sayisi: e.target.value })} className={ic}>
                          <option value="">Secin</option>
                          {['4+1', '8+1', '14+1', '16+1', '27+1', '36+1', '45+1'].map((k) => (
                      ...
                      <div>
                        <label className={lb}>Arac Tipi</label>
                        <select value={aracimiSatiyorum.arac_tipi}
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, arac_tipi: e.target.value })} className={ic}>
                          <option value="">Secin</option>
                          {['Minibus', 'Midibus', 'Otobus', 'Van', 'Sedan'].map((t) => (
                            <option key={t} value={t}>{t}</option>
                          ))}
                        </select>
                      </div>
                      <div>
                        <label className={lb}>KM</label>
                        <input type="number" value={aracimiSatiyorum.km} placeholder="150000"
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, km: e.target.value })} className={ic} />
                      </div>
                      <div>
                        <label className={lb}>Fiyat (TL)</label>
                        <input type="number" value={aracimiSatiyorum.ucret} placeholder="1200000"
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, ucret: e.target.value })} className={ic} />
                      </div>
                      <div>
                        <label className={lb}>Hasar Kaydi</label>
                        <select value={aracimiSatiyorum.hasar_kaydi}
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, hasar_kaydi: e.target.value })} className={ic}>
                    ...
                    <div className="flex flex-wrap gap-4">
                      <label className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer">
                        <input type="checkbox" checked={aracimiSatiyorum.noter_satisi}
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, noter_satisi: e.target.checked })}
                          className="accent-orange-500 w-4 h-4" />
                        Noter Satisi
                      </label>
                      <label className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer">
                        <input type="checkbox" checked={aracimiSatiyorum.aracla_birlikte_plaka}
                          onChange={(e) => setAracimiSatiyorum({ ...aracimiSatiyorum, aracla_birlikte_plaka: e.target.checked })}
                          className="accent-orange-500 w-4 h-4" />
                        Plakayla Birlikte
                      </label>
                    </div>
