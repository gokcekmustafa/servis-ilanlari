...
const badges: Record<KategoriType, { label: string; bg: string; text: string; border: string }> = {
  isim_var_arac:    { label: 'Araç Arıyorum',       bg: 'bg-blue-50',   text: 'text-blue-700',   border: 'border-blue-200' },
  aracim_var_is:    { label: 'İş Arıyorum',          bg: 'bg-green-50',  text: 'text-green-700',  border: 'border-green-200' },
  ...
  hostesim_is:      { label: 'Hostes İş Arıyor',     bg: 'bg-pink-50',   text: 'text-pink-700',   border: 'border-pink-200' },
  soforum_is:       { label: 'Şoför İş Arıyor',      bg: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
  plaka_satiyorum:  { label: 'Plaka Satılık',        bg: 'bg-red-50',    text: 'text-red-700',    border: 'border-red-200' },
  aracimi_satiyorum:{ label: 'Araç Satılık',         bg: 'bg-teal-50',   text: 'text-teal-700',   border: 'border-teal-200' },
};
